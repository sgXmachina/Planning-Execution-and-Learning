...
namespace lunar_lockout_ship
{
	...
	// new_board_ship_state.set_parent(*this);
	...
	// new_board_ship_state.print_grid();
	...
	// return new_board_ship_state;

	}

	bool board_ship_state::check_goal_reached()
	{
...
// bool board_ship_state::check_valid_move(unsigned int x_coord, unsigned int y_coord, direction dir)

// {

// }

	bool board_ship_state::get_valid()
	{
		return valid_;
	}
	...
	int board_ship_state::get_xy(const unsigned int x, const unsigned int y)
	{
		return grid_[x][y];
	}

	void board_ship_state::print_grid()
	{	
